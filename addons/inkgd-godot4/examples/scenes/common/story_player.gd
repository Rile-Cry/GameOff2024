...
var ChoiceContainer := load("res://addons/inkgd-godot4/examples/scenes/common/choice_container.tscn") as PackedScene
var LineLabel := load("res://addons/inkgd-godot4/examples/scenes/common/label.tscn") as PackedScene

var InkGDProfiler := load("res://addons/inkgd-godot4/examples/scenes/common/profiler.gd") as GDScript
